...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="%(dotdot)s%(STATIC_PATH)sres/css/main.min.css" />
    <link rel="shortcut icon" href="%(dotdot)s%(STATIC_PATH)sfavicon.ico" />
    <title>%(title)s</title>
</head>
    <scriptk src="%(dotdot)s%(STATIC_PATH)sres/js/main.min.js"></script>
    <scriptk src="%(dotdot)s%(STATIC_PATH)sres/js/angularjs-all.min.js"></script>
    <scriptk src="%(dotdot)s%(STATIC_PATH)sres/js/vendors.min.js"></script>
<body style="padding:15px;">
    <h1><a href="%(dotdot)s%(HOMEPAGE)s"><img
     src="%(dotdot)s%(STATIC_PATH)s/res/img/novacoin-32.png" alt="TryCoin Block explorer logo" /></a> TryCoin
    </h1>
    %(body)s
    ...
    <p style="font-size: smaller">
        ...
        %(download)s
        Tips appreciated!
        <a href="http://trycoin.co">TryCoin</a>
    </p>
</body>
</html>
"""
...
<span class="txid text-muted ng-binding">
'''
	body += [b['hash'],
'''</span>
...
<tbody>
<tr>
<td class="col-md-3"><strong translate=""><span class="ng-scope" style="font-weight:700">Transactions</span></strong></td>
<td class="text-right text-muted ng-binding">
'''
        ]
        body += [len(b['transactions']), '</td>\n</tr>']
        body += '''
<tr>
<td><strong translate=""><span class="ng-scope">Height</span></strong></td>
<td class="text-right text-muted ng-binding">
'''
        body += [b['height']]
        body += '''
...
<tr>
<td><strong translate=""><span class="ng-scope">Block Reward</span></strong></td>
<td class="text-right text-muted ng-binding">
'''
        ...
        if is_stake_chain:
            body += [
                'PoS' if is_stake_block else 'PoW',
                ': ',
                format_satoshis(b['generated'], chain), ' TCO generated',
                '</td>\n</tr>']
...
<td class="text-right">'''
            body += ['<a href="', dotdotblock,
                     b['hashPrev'], '" class=ng-binding>', b['hashPrev'][:4],'...',b['hashPrev'][-10:], '</a>\n','</td>\n</tr>']

        if b['next_block_hashes']:
            body += '''
<tr data-ng-show="block.nextblockhash" class="">
<td><strong translate=""><span class="ng-scope">Next Block</span></strong></td>
<td class="text-right">'''
            #body += ['Next Block: ']
        for hash in b['next_block_hashes']:
            body += ['<a href="', dotdotblock, hash, '" class=ng-binding>', hash[:4],'...',hash[-10:], '</a>\n</td>\n</tr>']
	body += [
            '<tr>\n<td>\nVersion\n</td>\n','<td class="text-right">', b['version'], '</td>\n</tr>\n',
            '<tr>\n<td>\nMerkle Root\n</td>\n','<td class="text-right">', b['hashMerkleRoot'], '</td>\n</tr>\n',
            '<tr>\n<td>\nTime\n</td>\n<td class="text-right">\n', b['nTime'], ' (', format_time(b['nTime']), ')</td>\n</tr>\n',
            '</tbody>\n</table>\n</div>\n<div class="col-md-6">\n<table class="table">\n<tbody>',
            '<tr>\n<td>\nDifficulty\n</td>\n<td class="text-right">\n', format_difficulty(util.calculate_difficulty(b['nBits'])),
            ' (Bits: %x)' % (b['nBits'],), '</td>\n</tr>\n',
            ...
            ['<tr>\n<td>\nAverage Coin Age\n</td>\n<td class="text-right">\n %6g' % (b['satoshi_seconds'] / 86400.0 / b['chain_satoshis'],),
             ' days\n</td>\n</tr>\n']
            ...
            ['<tr>\n<td>\nCumulative Coin-days Destroyed\n</td>\n<td class="text-right"> %6g%%</td>\n</tr>\n' %
             (100 * (1 - float(b['satoshi_seconds']) / b['chain_satoshi_seconds'] if b['chain_satoshi_seconds']>0 else 0),)]]
	body += '</tbody>\n</table></div>'
#        body += ['<h3>Transactions</h3>\n']

        for tx in b['transactions']:
            body += ['''
<div id="tx-263409205" class="txdiv">
<table class="table table-striped table-hover" cellpadding="0" cellspacing="0" style="padding:0px;float:left;margin:0px;width:100%">
<tbody>
	<tr>
		<th colspan="3" align="left">
			<a class="hash-link" href="../tx/''',
            tx['hash'],'">',tx['hash'],'</a>',''' 
			<span class="pull-right">mined ''',format_time(b['nTime']),'''</span>
		</th>
	</tr>
<tr>
<td class="col-md-5 txtd hidden-phone">''']
            if tx is b['transactions'][0]:
                body += [
                    'POS ' if is_stake_block else 'POW',
                    ' Newly Generated']
#, format_satoshis(b['generated'], chain), ' + ',
#                    format_satoshis(b['fees'], chain), ' total fees']
                ...
                for txin in tx['in']:
                    body += [abe.format_addresses(txin, page['dotdot'], chain),
                          ...
                          <span data-c="500000" data-time="1498473950000">''',
                             format_satoshis(txin['value'], chain),  '</span></span><br>']
            body += '</td>' 
#<a href="/address/1FgjFhNqMPowMgfavFyBcj9FWWu2XiNwUk">1FgjFhNqMPowMgfavFyBcj9FWWu2XiNwUk</a>
#<br>
#</td>
            body += ['''<td  class="col-md-2 hidden-phone" style="padding:4px;text-align:center;vertical-align:middle;">
<img src="../res/img/to.png"></td>
                    <td class="txtd col-md-5">''']
            txTotal = 0
            for txout in tx['out']:
                if is_stake_block:
                    if tx is b['transactions'][0]:
                        ...
                        assert len(tx['out']) == 1
                        body += ['''<span class="pull-right hidden-phone">
                          <span data-c="500000" data-time="1498473950000">''',
                ...
                body += [abe.format_addresses(txout, page['dotdot'], chain), 
                         '''<span class="pull-right hidden-phone">
                          <span data-c="500000" data-time="1498473950000">''',
                        format_satoshis(txout['value'], chain),'&nbsp; TCO</span></span><br>']
                txTotal += txout['value']#format_satoshis(txout['value'],chain)
...
<span data-c="185151573" data-time="1498473950000" data-original-title="" title="">Fee:&bsp;''',
...
<span data-c="185151573" data-time="1498473950000" data-original-title="" title="">''',format_satoshis(txTotal,chain),
'''&nbspTCO</span>
</button>
</div>
</div>
...
#Kevin:handle the page %hostname%/tx/...
    def show_tx(abe, page, tx):
        ...
        body += ['<blockquote>',abe.short_link(page, 't/' + hexb58(tx['hash'][:14])),'</blockquote>']
        body += ['<h2 translate=""><span class="ng-scope">Summary</span></h2>',
...
#        body += ['<p>Hash: ', tx['hash'], '<br />\n']
        ...
        body += ['<tr><td>Number of inputs</td><td>',len(tx['in']),'</td></tr>',
                '<tr><td>Total in</td><td>',format_satoshis(tx['value_in'],chain),'</td></tr>',
                '<tr><td>Numver of outputs</td><td>',len(tx['out']),'</td></tr>',
                ...
                '<tr><td>Fee</td><td>', format_satoshis(0 if is_coinbase else
                                     (tx['value_in'] and tx['value_out'] and
                                      tx['value_in'] - tx['value_out']), chain),'</td></tr>',
...
#            '<a href="../rawtx/', tx['hash'], '">Raw transaction</a><br />\n']
        ...
        body += ['</table></div><div class="col-md-6">\n',
...
#Kevin: handle the pange %host%/address/...
    def handle_address(abe, page):
        ...
        body += ['<blockquote>',abe.short_link(page, 'a/' + link),'</blockquote>']
...
#        body += ['<p>Balance: '] + format_amounts(balance, True)
        ...
        body += ['<table class="table table-striped col-md-6">',
                 ...
                 '<tr><td>Trasactions in</td><td>',counts[0],'</td></tr>',
                 '<tr><td>Received</td><td>',format_amounts(received, False),'</td></tr>',
                 '<tr><td>Trasactions out</td><td>',counts[1],'</td></tr>',
...
#
        ...
        for elt in txpoints:
            ...
            if elt['value'] < 0:
                value = '<font color="green">-' + format_satoshis(-elt['value'], chain) + '</font>'
            else:
                value = '<font color="red">' + format_satoshis(elt['value'], chain) + '</font>'
    ...
    def search_form(abe, page):
        ...
        return [
            ...
            '<button type="btn btn-success">Search</button>\n'
...
def redirect(page):
    ...
    return ('<html><head><title>Moved</title></head>\n'
            '<body style="padding:15px;"><h1>Moved</h1><p>This page has moved to '
